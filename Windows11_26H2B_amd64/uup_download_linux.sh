#!/bin/bash
#Generated on 2026-07-01 14:35:15 GMT
...
aria2c --no-conf --console-log-level=warn --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.cn/get.php?id=4a1ad84d-e423-495d-ba52-2496016b847e&pack=zh-cn&edition=professional;corecountryspecific&aria2=2"
if [ $? != 0 ]; then
