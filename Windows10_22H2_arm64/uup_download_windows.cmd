@echo off
:: Generated on 2026-07-16 13:11:43 GMT
...
:START_PROCESS
title 19045.7548_arm64_zh-cn_multi_d3045ccb download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=d3045ccb-b139-4a6d-97b0-09496b778119&pack=zh-cn&edition=professional%%3Bcorecountryspecific&aria2=2"
