@echo off
:: rem 生成时间 2026-05-31 14:41:23 GMT
:: 代理配置
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.cn/get.php?id=3918c293-2ddf-43f2-ae3c-a97fc9b9a9c1&pack=neutral&edition=app&aria2=2"
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.cn/get.php?id=3918c293-2ddf-43f2-ae3c-a97fc9b9a9c1&pack=zh-cn&edition=professional;corecountryspecific&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
