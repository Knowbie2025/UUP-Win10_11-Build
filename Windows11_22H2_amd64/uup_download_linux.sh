#!/bin/bash
#Generated on 2026-05-31 14:41:23 GMT
...
aria2c --no-conf --console-log-level=warn --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.cn/get.php?id=3918c293-2ddf-43f2-ae3c-a97fc9b9a9c1&pack=zh-cn&edition=professional;corecountryspecific&aria2=2"
if [ $? != 0 ]; then
