@echo off
:: Generated on 2026-05-30 11:04:33 GMT
...
:START_PROCESS
title 28000.2179_amd64_zh-cn_multi_ebfcd736 download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=ebfcd736-eb43-42c3-aff2-35445412d076&pack=zh-cn&edition=professional%%3Bcorecountryspecific&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
